...
strings.menu_entries = {
  ...
  new_entry = "[New entry]",
  item = "Item ",
  hint_items = { { pad = "cross", label = "Enter", row = 1 }, { pad = "square", label = "Delete", row = 1 }, { pad = "circle", label = "Back", row = 1 }, { pad = "L1", label = "Move up", row = 2 }, { pad = "R1", label = "Move down", row = 2 } },
  entry_index = "Entry ",
  name = "Name: ",
  paths = "Paths: ",
  args = "args: ",
