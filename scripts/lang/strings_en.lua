...
strings.menu_entries = {
  ...
  hint_items_with_enable = { { pad = "cross", label = "Enter", row = 1 }, { pad = "triangle", label = "Enable", row = 1 }, { pad = "select", label = "Insert", row = 1 }, { pad = "square", label = "Delete", row = 1 }, { pad = "circle", label = "Back", row = 1 }, { pad = "left", label = "Previous", row = 2 }, { pad = "L1", label = "Up", row = 2 }, { pad = "start", label = "Save", row = 2 }, { pad = "R1", label = "Down", row = 2 }, { pad = "right", label = "Next", row = 2 } },
  hint_items_with_disable = { { pad = "cross", label = "Enter", row = 1 }, { pad = "triangle", label = "Disable", row = 1 }, { pad = "select", label = "Insert", row = 1 }, { pad = "square", label = "Delete", row = 1 }, { pad = "circle", label = "Back", row = 1 }, { pad = "left", label = "Previous", row = 2 }, { pad = "L1", label = "Up", row = 2 }, { pad = "start", label = "Save", row = 2 }, { pad = "R1", label = "Down", row = 2 }, { pad = "right", label = "Next", row = 2 } },
  irx_hint_items = { { pad = "left", label = "Previous", row = 2 }, { pad = "L1", label = "Up", row = 2 }, { pad = "start", label = "Save", row = 2 }, { pad = "R1", label = "Down", row = 2 }, { pad = "right", label = "Next", row = 2 }, { pad = "cross", label = "Enter", row = 1 }, { pad = "triangle", label = "Disable", row = 1 }, { pad = "select", label = "Insert", row = 1 }, { pad = "square", label = "Delete", row = 1 }, { pad = "circle", label = "Back", row = 1 } },
  irx_hint_items_with_enable = { { pad = "left", label = "Previous", row = 2 }, { pad = "L1", label = "Up", row = 2 }, { pad = "start", label = "Save", row = 2 }, { pad = "R1", label = "Down", row = 2 }, { pad = "right", label = "Next", row = 2 }, { pad = "cross", label = "Enter", row = 1 }, { pad = "triangle", label = "Enable", row = 1 }, { pad = "select", label = "Insert", row = 1 }, { pad = "square", label = "Delete", row = 1 }, { pad = "circle", label = "Back", row = 1 } },
  irx_hint_items_with_disable = { { pad = "left", label = "Previous", row = 2 }, { pad = "L1", label = "Up", row = 2 }, { pad = "start", label = "Save", row = 2 }, { pad = "R1", label = "Down", row = 2 }, { pad = "right", label = "Next", row = 2 }, { pad = "cross", label = "Enter", row = 1 }, { pad = "triangle", label = "Disable", row = 1 }, { pad = "select", label = "Insert", row = 1 }, { pad = "square", label = "Delete", row = 1 }, { pad = "circle", label = "Back", row = 1 } },
  entry_index = "Entry ",
  name = "Name: ",
  paths = "Paths: ",
  args = "args: ",
  ...
  paths_hint_items_with_enable = { { pad = "left", label = "Previous", row = 2 }, { pad = "L1", label = "Up", row = 2 }, { pad = "", label = "", row = 2 }, { pad = "R1", label = "Down", row = 2 }, { pad = "right", label = "Next", row = 2 }, { pad = "cross", label = "Edit", row = 1 }, { pad = "triangle", label = "Enable", row = 1 }, { pad = "select", label = "Add", row = 1 }, { pad = "square", label = "Remove", row = 1 }, { pad = "circle", label = "Back", row = 1 } },
  paths_hint_items_with_disable = { { pad = "left", label = "Previous", row = 2 }, { pad = "L1", label = "Up", row = 2 }, { pad = "", label = "", row = 2 }, { pad = "R1", label = "Down", row = 2 }, { pad = "right", label = "Next", row = 2 }, { pad = "cross", label = "Edit", row = 1 }, { pad = "triangle", label = "Disable", row = 1 }, { pad = "select", label = "Add", row = 1 }, { pad = "square", label = "Remove", row = 1 }, { pad = "circle", label = "Back", row = 1 } },
  ...
  args_hint_items_with_enable = { { pad = "left", label = "Previous", row = 2 }, { pad = "L1", label = "Up", row = 2 }, { pad = "", label = "", row = 2 }, { pad = "R1", label = "Down", row = 2 }, { pad = "right", label = "Next", row = 2 }, { pad = "cross", label = "Edit", row = 1 }, { pad = "triangle", label = "Enable", row = 1 }, { pad = "select", label = "Add", row = 1 }, { pad = "square", label = "Remove", row = 1 }, { pad = "circle", label = "Back", row = 1 } },
  args_hint_items_with_disable = { { pad = "left", label = "Previous", row = 2 }, { pad = "L1", label = "Up", row = 2 }, { pad = "", label = "", row = 2 }, { pad = "R1", label = "Down", row = 2 }, { pad = "right", label = "Next", row = 2 }, { pad = "cross", label = "Edit", row = 1 }, { pad = "triangle", label = "Disable", row = 1 }, { pad = "select", label = "Add", row = 1 }, { pad = "square", label = "Remove", row = 1 }, { pad = "circle", label = "Back", row = 1 } },
...
strings.egsm = {
  ...
  hint_items_with_enable = { { pad = "left", label = "Previous", row = 2 }, { pad = "", label = "", row = 2 }, { pad = "start", label = "Save", row = 2 }, { pad = "", label = "", row = 2 }, { pad = "right", label = "Next", row = 2 }, { pad = "cross", label = "Edit", row = 1 }, { pad = "triangle", label = "Enable", row = 1 }, { pad = "select", label = "Insert", row = 1 }, { pad = "square", label = "Delete", row = 1 }, { pad = "circle", label = "Back", row = 1 } },
  hint_items_with_disable = { { pad = "left", label = "Previous", row = 2 }, { pad = "", label = "", row = 2 }, { pad = "start", label = "Save", row = 2 }, { pad = "", label = "", row = 2 }, { pad = "right", label = "Next", row = 2 }, { pad = "cross", label = "Edit", row = 1 }, { pad = "triangle", label = "Disable", row = 1 }, { pad = "select", label = "Insert", row = 1 }, { pad = "square", label = "Delete", row = 1 }, { pad = "circle", label = "Back", row = 1 } },
