...
strings.main = {
  ...
  main_hint_items_with_lang = { { pad = "up", label = "Up" }, { pad = "cross", label = "Enter" }, { pad = "down", label = "Down" }, { pad = "L1", label = "Language", row = 2 }, { pad = "start", label = "Exit", row = 2 }, { pad = "R1", label = "Language", row = 2 } },
  ...
  select_memory_card = "Select memory card",
  config_card_hint = "Config will be loaded/saved from this card",
...
strings.menu_entries = {
  ...
  item = "Item ",
  disabled = "Disabled",
  hint_items = { { pad = "cross", label = "Enter", row = 1 }, { pad = "square", label = "Delete", row = 1 }, { pad = "circle", label = "Back", row = 1 }, { pad = "left", label = "-10", row = 2 }, { pad = "L1", label = "Move up", row = 2 }, { pad = "R1", label = "Move down", row = 2 }, { pad = "right", label = "+10", row = 2 } },
  hint_items_with_enable = { { pad = "cross", label = "Enter", row = 1 }, { pad = "triangle", label = "Enable", row = 1 }, { pad = "square", label = "Delete", row = 1 }, { pad = "circle", label = "Back", row = 1 }, { pad = "left", label = "-10", row = 2 }, { pad = "L1", label = "Move up", row = 2 }, { pad = "R1", label = "Move down", row = 2 }, { pad = "right", label = "+10", row = 2 } },
  hint_items_with_disable = { { pad = "cross", label = "Enter", row = 1 }, { pad = "triangle", label = "Disable", row = 1 }, { pad = "square", label = "Delete", row = 1 }, { pad = "circle", label = "Back", row = 1 }, { pad = "left", label = "-10", row = 2 }, { pad = "L1", label = "Move up", row = 2 }, { pad = "R1", label = "Move down", row = 2 }, { pad = "right", label = "+10", row = 2 } },
  entry_index = "Entry ",
  name = "Name: ",
  paths = "Paths: ",
  args = "args: ",
  ...
  paths_hint_items = { { pad = "cross", label = "Add/edit", row = 1 }, { pad = "square", label = "Remove", row = 1 }, { pad = "circle", label = "Back", row = 1 }, { pad = "L1", label = "Move up", row = 2 }, { pad = "R1", label = "Move down", row = 2 } },
  args_for_entry = "Arguments for entry ",
  args_hint_items = { { pad = "cross", label = "Add/edit", row = 1 }, { pad = "square", label = "Remove", row = 1 }, { pad = "circle", label = "Back", row = 1 }, { pad = "L1", label = "Move up", row = 2 }, { pad = "R1", label = "Move down", row = 2 } },
...
strings.egsm = {
  ...
  disabled = "Disabled",
  hint_items = { { pad = "cross", label = "Add", row = 1 }, { pad = "square", label = "Delete", row = 1 }, { pad = "circle", label = "Back", row = 1 }, { pad = "left", label = "Value", row = 2 }, { pad = "start", label = "Save", row = 2 }, { pad = "right", label = "Value", row = 2 } },
}
