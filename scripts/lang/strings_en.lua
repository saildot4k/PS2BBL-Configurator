...
strings.menu_entries = {
  ...
  paths_hint_items = { { pad = "cross", label = "Edit", row = 1 }, { pad = "square", label = "Remove", row = 1 }, { pad = "circle", label = "Back", row = 1 }, { pad = "L1", label = "Move up", row = 2 }, { pad = "select", label = "Add", row = 2 }, { pad = "R1", label = "Move down", row = 2 } },
  args_for_entry = "Arguments for entry ",
  args_hint_items = { { pad = "cross", label = "Edit", row = 1 }, { pad = "square", label = "Remove", row = 1 }, { pad = "circle", label = "Back", row = 1 }, { pad = "L1", label = "Move up", row = 2 }, { pad = "select", label = "Add", row = 2 }, { pad = "R1", label = "Move down", row = 2 } },
