...
strings.menu_entries = {
  ...
  irx_hint_items = { { pad = "left", label = "Anterior", row = 2 }, { pad = "L1", label = "Arriba", row = 2 }, { pad = "start", label = "Guardar", row = 2 }, { pad = "R1", label = "Abajo", row = 2 }, { pad = "right", label = "Siguiente", row = 2 }, { pad = "cross", label = "Entrar", row = 1 }, { pad = "triangle", label = "Deshab.", row = 1 }, { pad = "select", label = "Insertar", row = 1 }, { pad = "square", label = "Eliminar", row = 1 }, { pad = "circle", label = "Atrás", row = 1 } },
  irx_hint_items_with_enable = { { pad = "left", label = "Anterior", row = 2 }, { pad = "L1", label = "Arriba", row = 2 }, { pad = "start", label = "Guardar", row = 2 }, { pad = "R1", label = "Abajo", row = 2 }, { pad = "right", label = "Siguiente", row = 2 }, { pad = "cross", label = "Entrar", row = 1 }, { pad = "triangle", label = "Habilitar", row = 1 }, { pad = "select", label = "Insertar", row = 1 }, { pad = "square", label = "Eliminar", row = 1 }, { pad = "circle", label = "Atrás", row = 1 } },
  ...
  paths_hint_items_with_enable = { { pad = "left", label = "Anterior", row = 2 }, { pad = "L1", label = "Arriba", row = 2 }, { pad = "", label = "", row = 2 }, { pad = "R1", label = "Abajo", row = 2 }, { pad = "right", label = "Siguiente", row = 2 }, { pad = "cross", label = "Editar", row = 1 }, { pad = "triangle", label = "Habilitar", row = 1 }, { pad = "select", label = "Añadir", row = 1 }, { pad = "square", label = "Eliminar", row = 1 }, { pad = "circle", label = "Atrás", row = 1 } },
  paths_hint_items_with_disable = { { pad = "left", label = "Anterior", row = 2 }, { pad = "L1", label = "Arriba", row = 2 }, { pad = "", label = "", row = 2 }, { pad = "R1", label = "Abajo", row = 2 }, { pad = "right", label = "Siguiente", row = 2 }, { pad = "cross", label = "Editar", row = 1 }, { pad = "triangle", label = "Deshab.", row = 1 }, { pad = "select", label = "Añadir", row = 1 }, { pad = "square", label = "Eliminar", row = 1 }, { pad = "circle", label = "Atrás", row = 1 } },
  ...
  args_hint_items_with_enable = { { pad = "left", label = "Anterior", row = 2 }, { pad = "L1", label = "Arriba", row = 2 }, { pad = "", label = "", row = 2 }, { pad = "R1", label = "Abajo", row = 2 }, { pad = "right", label = "Siguiente", row = 2 }, { pad = "cross", label = "Editar", row = 1 }, { pad = "triangle", label = "Habilitar", row = 1 }, { pad = "select", label = "Añadir", row = 1 }, { pad = "square", label = "Eliminar", row = 1 }, { pad = "circle", label = "Atrás", row = 1 } },
  args_hint_items_with_disable = { { pad = "left", label = "Anterior", row = 2 }, { pad = "L1", label = "Arriba", row = 2 }, { pad = "", label = "", row = 2 }, { pad = "R1", label = "Abajo", row = 2 }, { pad = "right", label = "Siguiente", row = 2 }, { pad = "cross", label = "Editar", row = 1 }, { pad = "triangle", label = "Deshab.", row = 1 }, { pad = "select", label = "Añadir", row = 1 }, { pad = "square", label = "Eliminar", row = 1 }, { pad = "circle", label = "Atrás", row = 1 } },
...
strings.egsm = {
  ...
  hint_items_with_enable = { { pad = "left", label = "Anterior", row = 2 }, { pad = "", label = "", row = 2 }, { pad = "start", label = "Guardar", row = 2 }, { pad = "", label = "", row = 2 }, { pad = "right", label = "Siguiente", row = 2 }, { pad = "cross", label = "Editar", row = 1 }, { pad = "triangle", label = "Habilitar", row = 1 }, { pad = "select", label = "Insertar", row = 1 }, { pad = "square", label = "Eliminar", row = 1 }, { pad = "circle", label = "Atrás", row = 1 } },
  hint_items_with_disable = { { pad = "left", label = "Anterior", row = 2 }, { pad = "", label = "", row = 2 }, { pad = "start", label = "Guardar", row = 2 }, { pad = "", label = "", row = 2 }, { pad = "right", label = "Siguiente", row = 2 }, { pad = "cross", label = "Editar", row = 1 }, { pad = "triangle", label = "Deshab.", row = 1 }, { pad = "select", label = "Insertar", row = 1 }, { pad = "square", label = "Eliminar", row = 1 }, { pad = "circle", label = "Atrás", row = 1 } },
