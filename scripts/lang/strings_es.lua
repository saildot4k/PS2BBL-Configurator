...
strings.menu_entries = {
  ...
  irx_hint_items_with_enable = { { pad = "", label = "", row = 2 }, { pad = "L1", label = "Arriba", row = 2 }, { pad = "start", label = "Guardar", row = 2 }, { pad = "R1", label = "Abajo", row = 2 }, { pad = "", label = "", row = 2 }, { pad = "cross", label = "Entrar", row = 1 }, { pad = "triangle", label = "Habilitar", row = 1 }, { pad = "select", label = "Insertar", row = 1 }, { pad = "square", label = "Eliminar", row = 1 }, { pad = "circle", label = "Atrás", row = 1 } },
  irx_hint_items_with_disable = { { pad = "", label = "", row = 2 }, { pad = "L1", label = "Arriba", row = 2 }, { pad = "start", label = "Guardar", row = 2 }, { pad = "R1", label = "Abajo", row = 2 }, { pad = "", label = "", row = 2 }, { pad = "cross", label = "Entrar", row = 1 }, { pad = "triangle", label = "Deshab.", row = 1 }, { pad = "select", label = "Insertar", row = 1 }, { pad = "square", label = "Eliminar", row = 1 }, { pad = "circle", label = "Atrás", row = 1 } },
  entry_index = "Entrada ",
  name = "Nombre: ",
  paths = "Rutas: ",
  args = "args: ",
