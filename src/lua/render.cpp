...
static int lua_loadobj(lua_State *L) {
  ...
  GSTEXTURE *text = NULL;
  if (argc == 2)
    text = (GSTEXTURE *)(luaL_checkinteger(L, 2));
...
static const luaL_Reg Render_functions[] = {{"init", lua_initrender},   {"loadOBJ", lua_loadobj}, {"drawOBJ", lua_drawobj},
                                            {"drawBbox", lua_drawbbox}, {"freeOBJ", lua_freeobj}, {0, 0}};
...
static const luaL_Reg Lights_functions[] = {{"set", lua_createlight}, {"create", lua_lightnumber}, {0, 0}};
...
static const luaL_Reg Camera_functions[] = {{"position", lua_camposition}, {"rotation", lua_camrotation}, {0, 0}};
